...
1. Upload the entire /dfe_news_harvester folder to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Begin registering feeds and setting up configuration in the plugin's menu pages.